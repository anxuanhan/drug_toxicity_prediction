...
parser = argparse.ArgumentParser(description="Please enter the absolute path of the csv file")
parser.add_argument('path', type=str, help="The absolute path to the file")
